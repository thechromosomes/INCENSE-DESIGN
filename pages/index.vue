                          ...
                          <div class="ekit-wid-con">
                            ...
                            >
                              ...
                              <div class="ekit-heading__description">
                                <p>ARCHITECTURE INTERIOR FURNITURE</p>
                              </div>
                            </div>
                          </div>
                        </div>
                                      ...
                                      <div class="elementor-icon-box-wrapper">
                                        <div class="elementor-icon-box-icon">
                                          <span
                                            ...
                                            "
                                          >
                                            <img src="~/assets/img/warranty.png" alt="" class="img-icons">
                                          </span>
                                        </div>
                                      ...
                                      <div class="elementor-icon-box-wrapper">
                                        <div class="elementor-icon-box-icon">
                                          <span
                                            ...
                                            "
                                          >
                                            <img src="~/assets/img/save-money.png" alt="save-money" class="img-icons">
                                          </span>
                                        </div>
                                        <div class="elementor-icon-box-content">
                                          <h3 class="elementor-icon-box-title">
                                      ...
                                      <div class="elementor-icon-box-wrapper">
                                        <div class="elementor-icon-box-icon">
                                          <span
                                            ...
                                            "
                                          >
                    <img src="~/assets/img/advice.png" alt="advice" class="img-icons">
                                          </span>
                                        </div>
                                        <div class="elementor-icon-box-content">
                                          <h3 class="elementor-icon-box-title">
                                            <span>  Experts Advice </span>
                                          </h3>
                                        </div>
                                      </div>
                                    </div>
                                      ...
                                      <div class="elementor-icon-box-wrapper">
                                        <div class="elementor-icon-box-icon">
                                          <span
                                            ...
                                            "
                                          >
                                           <img src="~/assets/img/idea.png" alt="idea" class="img-icons">
                                          </span>
                                        </div>
                                        <div class="elementor-icon-box-content">
                                          <h3 class="elementor-icon-box-title">
                                      ...
                                      <div class="elementor-icon-box-wrapper">
                                        <div class="elementor-icon-box-icon">
                                          <span
                                            ...
                                            "
                                          >
                                          <img src="~/assets/img/assurance.png" class="img-icons">
                                          </span>
                                        </div>
                                        <div class="elementor-icon-box-content">
                                          <h3 class="elementor-icon-box-title">
                                            <span> Assured After Service</span>
                                          </h3>
                                        </div>
                                      </div>
                                    </div>
                                                  ...
                                                  <div class="ekit-wid-con">
                                                    ...
                                                    >
                                                      <h2
                                                        ...
                                                        "
                                                      >
                                                       Want To See How Your Space Can be 
                                                        <span
                                                          ><span
                                                            >Transformed?</span
                                                          ></span
